...
def test_jnu_not_cfd():
    d = _doc("docs/YUANTA_LEVERAGED_TRADING_API.md")
...
def test_leveraged_api_not_core():
    ...
    m = yaml.safe_load((ROOT / "SYSTEM_MANIFEST.yaml").read_text(encoding="utf-8"))
...
def test_proprietary_leverage_pdf_excluded():
    exc = _doc("PUBLICATION_EXCLUDE_MANIFEST.txt")
