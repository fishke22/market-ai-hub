...
- [Windows installation](getting-started/windows-installation.md)
...
- [Data updates](guides/data-updates.md)
...
- [System prompt V4.1 (recommended)](prompts/SYSTEM_PROMPT_V4_1_COMPACT.md)
- [System prompt V4 (full reference)](prompts/SYSTEM_PROMPT_V4_PHASE2_RC1.md)
- [System prompt V3.3 (historical)](prompts/SYSTEM_PROMPT_V3_3_REFERENCE.md)
- [Quick prompts](prompts/QUICK_PROMPTS.md)
