...
def runtime_verification_requirements() -> dict[str, Any]:
    ...
    return {
        ...
        "required_checks": [
            ...
            "runtime process build id frozen at recorder startup and matches current disk build",
            "no prior same-contract tick-detail attempt in the current recorder process",
